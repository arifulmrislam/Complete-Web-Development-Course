/**
 * 1. use form tag and onSubmit handle with event (e) 
 ...
 * 
 * 4. uncontrolled element: useRef to create a reference to the element and access value bhy: nameRef.current.value
 * 
